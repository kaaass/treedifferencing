...
public class MtDiffOptimizedMatcher extends Matcher {
    ...
    private void computeMatchingPairs() throws Exception {
        ...
        List<Entry<Integer, Integer>> list = new LinkedList<>(tagSizeMap.entrySet());
    ...
    private void matchInnerNodes(IdentityHashMap<ITree, Integer> orderedList1,
             ...
             ArrayList<ITree> unmatchedNodesOrdered1,
             ArrayList<ITree> unmatchedNodesOrdered2,
        ...
        InnerNodeSimilarityCalculator innerMatcher2 = new InnerNodeSimilarityCalculator(labelConfiguration, leavesMap1,
    ...
    private void matchLeaves(IdentityHashMap<ITree, Integer> orderedList1,
                             ...
                             Set<ITree> unmatchedNodes2, boolean onlyOneClassPair, List<Entry<Integer, Integer>> list,
        ...
        for (Entry<Integer, Integer> tagEntry : list) {
            ...
            for (Future<LeafSimResults<ITree>> fu : leafSimResults) {
                ...
                try {
                    ...
                    for (final Entry<ITree, ArrayList<MatchingCandidate>> entry
            ...
            for (int i = 0; i < oldNodeArray.size(); i++) {
                ...
                SimilarLeafExaminationRunnable treeDiffRunnable =
                        new SimilarLeafExaminationRunnable(oldNodeList, newNodeList, subList, treeDiffCounter,
