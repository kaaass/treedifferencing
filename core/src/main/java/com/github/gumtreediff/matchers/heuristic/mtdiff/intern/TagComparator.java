...
public class TagComparator implements Comparator<Entry<Integer, Integer>> {
    ...
    public int compare(Entry<Integer, Integer> o1, Entry<Integer, Integer> o2) {
        if (((Entry<Integer, Integer>) (o1)).getKey() == labelConfiguration.identifierLabel) {
            return Integer.MIN_VALUE;
        } else if (((Entry<Integer, Integer>) (o2)).getKey() == labelConfiguration.identifierLabel) {
