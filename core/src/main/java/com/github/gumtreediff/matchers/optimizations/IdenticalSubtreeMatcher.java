...
public class IdenticalSubtreeMatcher extends Matcher {

	public IdenticalSubtreeMatcher(ITree src, ITree dst, MappingStore store) {
		super(src, dst, store);

	}

	public String getHash(ITree node, HashMap<ITree, Integer> quickFind, HashMap<ITree, String> stringMap) {
	...
	public void newUnchangedMatching() {
